...
from verde.comments import contains_pragma_comment
from verde.lines import Indentation, Line, append_leaves
from verde.mode import Feature, Mode, Quote
...
from verde.rusty import Err, Ok, Result
...
class StringMerger(StringTransformer, CustomSplitMapMixin):
    ...
    def _merge_one_string_group(
        ...
        BREAK_MARK = "@@@@@ VERDE BREAKPOINT MARKER @@@@@"
