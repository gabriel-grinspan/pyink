...
def get_cache_dir() -> Path:
    """Get the cache directory used by verde.

    Users can customize this directory on all systems using `VERDE_CACHE_DIR`
    environment variable. By default, the cache directory is the user cache directory
    under the black application.

    This result is immediately set to a constant `verde.cache.CACHE_DIR` as to avoid
    repeated calls.
    """
